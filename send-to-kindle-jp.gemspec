...
require 'send/to/kindle/jp/version'

Gem::Specification.new do |spec|
  spec.name          = "send-to-kindle-jp"
  spec.version       = Send::To::Kindle::Jp::VERSION
  ...
  spec.homepage      = "https://github.com/urokuta/send-to-kindle-jp"
  spec.license       = "MIT"
